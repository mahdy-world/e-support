...
class CreateIssueForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['id', 'title', 'issue_type', 'channel', 'module','device_serial',
                  'description', 'affects_version', 'train_number' , 'train_to', 'train_from', 'priority', 'station', 'subscription_type', 'subscription_number',
        ...
        widgets = {
            ...
            'train_number': forms.TextInput(attrs={'class': 'form-control border border-primary ', 'id': 'train_number','name': 'train_number'}),
